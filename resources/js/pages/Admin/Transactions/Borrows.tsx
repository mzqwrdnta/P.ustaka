...
export default function AdminTransactionsBorrows({ transactions, filters }: any) {
    ...
    return (
        <AppLayout breadcrumbs={[{ title: 'Kelola Peminjaman', href: '/admin/transactions/borrows' }]}>
                                            ...
                                            <div className="flex gap-1.5 justify-center">
                                                ...
                                                {trx.status === 'pending_peminjaman' && (
                                                    <>
                                                        ...
                                                        <Link method="post" href={`/admin/transactions/${trx.id}/reject-borrow`} as="button" className="text-xs bg-rose-600 hover:bg-rose-700 text-white px-2.5 py-1.5 rounded font-medium transition-colors">Tolak</Link>
                                                    </>
                                                )}
                                            </div>
                                        </td>
