...
export default function AdminBooksCreate() {
    ...
    return (
        <AppLayout breadcrumbs={[{ title: 'Kelola Buku', href: '/admin/books' }, { title: 'Tambah Buku', href: '/admin/books/create' }]}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4 max-w-2xl mx-auto w-full">
                <div className="border-border/50 rounded-xl border bg-white p-6 shadow-sm dark:bg-zinc-900">
                    <h2 className="text-xl font-bold mb-6">Tambah Buku Baru</h2>
                    ...
                    <form onSubmit={submit} className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <Label htmlFor="cover_image">Cover Buku (Opsional)</Label>
                                <Input 
                                    id="cover_image" 
                                    type="file" 
                                    accept="image/*"
